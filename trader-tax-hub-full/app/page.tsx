    ...
    <div className="space-y-14">
      ...
      <Section title="Downloads & Tools">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <DownloadCard title="Trader Accounting Toolkit" href="/downloads/Trader_Accounting_Toolkit_Calum.xlsx" />
          <DownloadCard title="Retail Trader Tax Process (PDF)" href="/downloads/Retail_Trader_Tax_Process_Full_Calum.pdf" />
          <DownloadCard title="QuickBooks for Traders (PDF)" href="/downloads/QuickBooks_For_Traders_Calum.pdf" />
          <DownloadCard title="Income Streams Guide (PDF)" href="/downloads/Expanded_Trading_and_Bookkeeping_Income_Streams.pdf" />
        </div>
      </Section>
